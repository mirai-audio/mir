...
export default {
  about: {
    copy:
      "すべての音楽ストリーミングサービスを統合するオーディオアプリ。" +
  ...
  app: {
    ...
    noscript: {
      ...
      copy:
        "mirai.audioチームはJavaScriptを無効にするという決定を尊重します。" +
  ...
  components: {
    ...
    "ma-create-media": {
      ...
      "error-ember-data-request-post-http":
        "An error occurred, try again later.",
      "media-title-label": "タイトル",
      "media-title-placeholder": "タイトル",
      "media-url-label": "URL",
  ...
  routes: {
    ...
    styleguide: {
      ...
      "lorem-ipsum":
        ...
        "数体である定義体（英語版） (field of definition)を持っている。",
